...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2024 at 02:06 AM
...
CREATE TABLE `mytable` (
  `search_image` varchar(179) COLLATE utf8_unicode_ci NOT NULL,
  `styleid` int(11) NOT NULL,
  `brands_filter_facet` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `price` int(11) NOT NULL,
  `product_additional_info` varchar(30) COLLATE utf8_unicode_ci NOT NULL
